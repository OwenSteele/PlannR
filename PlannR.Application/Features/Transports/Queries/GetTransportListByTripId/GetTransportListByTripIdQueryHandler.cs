...
{
    public class GetTransportListByTripIdQueryHandler
    {
        ...
        public async Task<ICollection<TransportListByTripIdViewModel>> Handle(TransportListByTripIdViewModel request, CancellationToken cancellationToken)
        {
